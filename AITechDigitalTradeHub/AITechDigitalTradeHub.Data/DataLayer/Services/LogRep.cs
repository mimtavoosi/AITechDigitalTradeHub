...
namespace AITechDigitalTradeHub.Data.DataLayer.Services
{
    public class LogRep : ILogRep
    {
        ...
        public LogRep(TheAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<ListResultObject<Log>> GetAllLogsAsync(int pageIndex = 1, int pageSize = 20, string searchText = "",string sortQuery ="")
        {
